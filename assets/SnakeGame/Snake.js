let snakeColor;
(async() => {
    snakeColor = await window.getSnakeColor();
})();
setTimeout(() => {
    var deathAnimationFrame = 0;
    var deathAnimationColor;
                ...
                overTakesTail(newPos, h, t) {
                    ...
                    getPathBasedOnAStar() {
                        ...
                        while (true) {
                            ...
                            //if the final node has been visited and the previous visit was a shorter path then f*** this path
                    ...
                    resetAnimation(){
                        if(deathAnimationFrame == 0) deathAnimationColor = snakeColor;
                        
                        deathAnimationFrame++;
                        if(deathAnimationFrame % 20 == 10 && deathAnimationFrame != 110){
                            snakeColor = [255, 255, 255];
                            
                        } else if(deathAnimationFrame % 20 == 0){
                            snakeColor = deathAnimationColor;
                        }
                        
                        if(deathAnimationFrame == 130){
                            snakeColor = deathAnimationColor;
                            deathAnimationFrame = 0;
                            this.dead = false;
                            console.log("Snake died, Restarting...")
                    ...
                    checkCollisions() {
                        ...
                        if (blocksX * blocksY - (this.tailBlocks.length + 1) <= 0) {
                            this.weWin = true;
                            console.log("Snake won! Restarting...")
...
window.Snake = Snake;
                        ...
                        need to fix A* being s***
                        need to use A* more late game because its s***
                        */
